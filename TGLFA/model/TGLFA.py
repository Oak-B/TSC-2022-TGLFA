        ...
        for ind, w in enumerate(self.decoder_w):
            ...
            if ind == len(self._layer_sizes) - self.shift:
                if self.layer_num == 1:
                    ...
                    x = (self.first_x + self.second_x + x)
                elif self.layer_num == 4:
                    x = (self.first_x + self.second_x + self.third_x + x)
                elif self.layer_num == 5:
                    x = (self.first_x + self.second_x + self.third_x + self.forth_x + x)
                ...
                light_out = torch.mm(self.graph, all_emb)
                # light_out = all_emb / 6
